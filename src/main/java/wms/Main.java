    ...
    while (running) {
        ...
        switch (choice) {
            case 1:
                ...
                Product product = new Product(id, name, quantity, price, threshold);
                warehouseManager.getInventoryManager().addProduct(product);
                break;
            ...
            case 2:
                ...
                Supplier supplier = new Supplier(supplierId, supplierName, contact);
                warehouseManager.getSupplierManager().addSupplier(supplier);
                break;
            ...
            case 3:
                ...
                Supplier foundSupplier = warehouseManager.getSupplierManager().getSupplierById(sId);
                Product foundProduct = warehouseManager.getInventoryManager().getProductById(pid);

                if (foundSupplier != null && foundProduct != null) {
                    warehouseManager.getOrderManager().createPurchaseOrder(poId, foundSupplier, foundProduct, poQ);
                } else {
                    System.out.println("Invalid supplier or product ID");
                }
                break;
            ...
            case 4:
                System.out.print("Enter purchase order ID to receive: ");
                int receiveId = scanner.nextInt();
                warehouseManager.getOrderManager().receivePurchaseOrder(receiveId);
                break;
            ...
            case 5:
                ...
                while (addingItems) {
                    System.out.println("Enter the ID of the product you are purchasing (or -1 if you want to exit the program)");
                    int pId = scanner.nextInt();
                    ...
                    Product match = warehouseManager.getInventoryManager().getProductById(pId);
                    if (match != null) {
                        co.addProduct(match, pQuantity);
                    } else {
                        System.out.println("Product not found");
                ...
                warehouseManager.getOrderManager().addCustomerOrder(co);
                System.out.println("Total order value: £" + co.calculateTotal());
                break;
            ...
            case 6:
                ...
                CustomerOrder orderProcess = null;
                for (CustomerOrder order : warehouseManager.getOrderManager().getCustomerOrders()) {
                    if (order.getId() == processId) {
                        orderProcess = order;
                        break;
                    }
                ...
                if (orderProcess != null) {
                    warehouseManager.getOrderManager().processCustomerOrder(orderProcess);
                    System.out.println("Total order value: £" + orderProcess.calculateTotal());
                } else {
                    System.out.println("Customer order not found");
                }
            ...
            case 7:
                System.out.println("Products in Warehouse");
                for (Product p : warehouseManager.getInventoryManager().getProducts()) {
                    System.out.println(p);
                    if (p.isLowStock()) {
                        System.out.println("LOW STOCK");
                    } else {
            ...
            case 8:
                System.out.println(" Suppliers:");
                for (Supplier s : warehouseManager.getSupplierManager().getSuppliers()) {
            ...
            case 9:
                System.out.print("Enter supplier ID to view order history: ");
                int sID = scanner.nextInt();
                Supplier supplier1 = warehouseManager.getSupplierManager().getSupplierById(sID);

                if (supplier1 != null) {
                    warehouseManager.getSupplierManager().printSupplierOrderHistory(supplier1);
                } else {
                    System.out.println("Supplier not found.");
                }
                break;
            ...
            case 10:
                System.out.println("Financial Report:");
                System.out.println("Total revenue: £"
                        + String.format("%.2f", warehouseManager.getFinanceManager().getTotalRevenue()));
                System.out.println("Total Expenses: £"
                        + String.format("%.2f", warehouseManager.getFinanceManager().getTotalExpenses()));
                System.out.println("Net Income: £"
                        + String.format("%.2f", warehouseManager.getFinanceManager().getNetIncome()));
                break;
            ...
            case 11:
                ...
                Supplier toUpdate = warehouseManager.getSupplierManager().getSupplierById(updateId);
                ...
                if (toUpdate != null) {
                    ...
                    warehouseManager.getSupplierManager().updateSupplier(updateId, newName, newContact);
                } else {
                    System.out.println("Supplier not found.");
                }
                break;
            ...
            case 12:
                ...
                warehouseManager.getSupplierManager().removeSupplier(removeId);
                break;
